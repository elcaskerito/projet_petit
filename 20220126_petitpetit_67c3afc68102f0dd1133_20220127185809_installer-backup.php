...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220126_petitpetit_67c3afc68102f0dd1133_20220127185809_archive.zip';
	const ARCHIVE_SIZE		 = '104553547';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '67c3afc-27185809';
    const SECONDARY_PACKAGE_HASH = 'efcd776-27185809';
	const VERSION			 = '1.4.3';
